...
// For readability.
#define gPrologueEngineData ((struct RapMenPrologueEngineData *)gCurrentEngineData)
...
void func_08046f6c(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(get_current_mem_id(), rap_men_prologue_gfx_table, 0x2000);
    run_func_after_task(task, func_08046f5c, 0);
}
...
void func_08046f9c(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = start_new_texture_loader(get_current_mem_id(), rap_men_prologue_buffered_textures);
    run_func_after_task(task, func_08046f6c, 0);
}
...
void rap_men_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = sprite_create(gSpriteHandler, anim_rap_men_prologue_title, 0, 57, 25, 0, 0, 0x7f, 0);
}

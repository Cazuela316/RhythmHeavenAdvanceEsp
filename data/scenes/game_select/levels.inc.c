...
struct LevelData level_data_table[] = {
    ...
    /* KARATE_MAN */ {
        ...
        /* Epilogue Text */ {
            ...
            /* OK        */ "Pues no ganáQ, àøpero sáe que le di pelea!",
            /* SUPERB    */ "àøGanáQ el torneo y me lleváQ el oro a casa!"
        },
    ...
    /* RHYTHM_TWEEZERS */ {
        ...
        /* Epilogue Text */ {
            /* TRY_AGAIN */ "àøNo puedo arrancar nada asáe de rácpido!",
            /* OK        */ "Estos pelos sáe que son rebeldes de depilar.",
            /* SUPERB    */ "àøMira esas flores! QuáQ relajante..."
        },
        /* Level Flags   */ LEVEL_DATA_FLAG_IS_EXTRA | LEVEL_DATA_FLAG_NO_PRACTICE
    },
    /* MARCHING_ORDERS */ {
        ...
        /* Epilogue Text */ {
            /* TRY_AGAIN */ "àøMONSTRUO! àøRetirada! àøRetirada!",
            /* OK        */ "àøAh, aháe estác el cachorro perdido!",
            /* SUPERB    */ "àøHemos rescatado al cachorro! àøViva!"
        },
        /* Level Flags   */ LEVEL_DATA_FLAG_IS_EXTRA | LEVEL_DATA_FLAG_NO_PRACTICE
    },
    /* SPACEBALL */ {
        ...
        /* Epilogue Text */ {
            /* TRY_AGAIN */ "àøAhhh! àøNooooooo!",
            /* OK        */ "àøGraaaah!",
            /* SUPERB    */ "àøUn home run! àøLo lográQ!"
        },
        /* Level Flags   */ LEVEL_DATA_FLAG_IS_EXTRA | LEVEL_DATA_FLAG_NO_PRACTICE
    },
    /* CLAPPY_TRIO */ {
        ...
        /* Epilogue Text */ {
            /* TRY_AGAIN */ "àøEsperen! àøNo nos dejen!",
            /* OK        */ "àøPues este sáe que es un buen crucero espacial!",
            /* SUPERB    */ "àøDescubri un nuevo planeta! àøGarboso!"
        },
        /* Level Flags   */ LEVEL_DATA_FLAG_IS_EXTRA | LEVEL_DATA_FLAG_NO_PRACTICE
    },
    /* REMIX_1 */ {
        ...
        /* Epilogue Text */ {
            /* TRY_AGAIN */ "Aà¶n queda un largo camino...",
            /* OK        */ "Aà¶n eres un lindo pollito. àøPio-Pio!",
            /* SUPERB    */ "àøHas crecido de maravilla! àøPareces hasta un rey!"
        },
        /* Level Flags   */ LEVEL_DATA_FLAG_IS_EXTRA | LEVEL_DATA_FLAG_NO_PRACTICE
    }
};

...
struct ReadingMaterial reading_material_table[] = {
    ...
    /* MANUAL ("Handling Instructions") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "àæRealmente QuáQ puedo decir...?\n"
            "Ah, sáe, la ideas es que juegues al son de la mà¶sica,\n"
            "asáe que intenta sentir el flow. àøEse es mi consejo!\n"
            "Y eso es todo. Y, por cierto, àøun placer conocerte!",
        /* STYLE ---------------------------------------------------------- */
    ...
    /* CAFE ("More Than a Barista") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "àøy un par ha sacado puntajes perfectos!\n"
            "àøSiempre me asombran!\n"
            ...
            "trabajo, àøsiempre estoy bailando con estos\n"
            "auriculares para perro! àæQuáQ puedo decir?\n"
            "Necesito un poco de flow a donde sea que vaya.\n"
            "Es complicado. Jeje...\n"
            "Salgo de vez en cuando, asáe que si me ves...\n"
            "àøpor favor acaráeciame!\n"
            "Te veo luego.",
        /* STYLE ---------------------------------------------------------- */
    ...
    /* RHYTHM_TWEEZERS ("Letter to the Editor") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "de vegetales. Pero verács, àøde un dáea a otro a mis\n"
            "vegetales les empezo a crecer pelo!\n"
            "àøFue muy raro! àøNo podráea simplemente venderlas asáe!\n"
            "IntentáQ arrancar los pelos, pero no podáea dejarlas\n"
            "totalmente depiladas, àøera un problema terrible!\n"
            "Pero bueno, para mejorar mi ácnimo, Puse un poco\n"
            "de mà¶sica.\n"
            "Y sin darme cuenta, àøEstaba arrancando los pelos al\n"
            "ritmo de la mà¶sica!\n"
            "Y asáe... àøQuedaron totalmente depiladas! àøIncluso\n"
            "hasta fue un poco divertido!\n"
            "àøEl poder de la mà¶sica si que hace maravillas!\n"
            "Si por alguna razon tienes mi mismo problema, con\n"
            "los pelos de tus vegetales...\n"
            "àøTe recomiendo poner buena mà¶sica y arrancar\n"
            "los pelos con ritmo!",
        /* STYLE ---------------------------------------------------------- */
            /* GFX */ reading_style_train_gfx_table,
            /* BGM */ &reading_style_train_bgm
    ...
    /* SPACEBALL ("Inside Spaceball") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "àøEl Bateador Espacial!\n"
            "\n"
            "P. àæCáimo va la temporada hasta ahora?\n"
            "R. He estado comiendo bolas de arroz, àøasáe que muy\n"
            "bien!\n"
            "\n"
            "\n"
            "P. àæCuácl diráeas que es tu meta?\n"
            "R. àøNo dejar de comer bolas de arroz!\n"
            "\n"
            "P. Tienes una novia, àæverdad?\n"
            "R. Si, tengo una novia.\n"
            "\n"
            "P. àæCuácl diráeas que es su mejor cualidad?\n"
            "R. àøHace muy buenas bolas de arroz!\n"
            "\n"
            "P. àæPor que te pones mácscaras en medio del juego?\n"
            "R. àæHm? àæDe que hablas?\n"
            "\n"
            "P. Pues, Como ese unáeforme de conejo que te pusiste.\n"
            "R. No tengo idea de lo que estas hablando.\n"
            "\n"
            "P. àøPor favor, responde mi pregunta!\n"
            "R. Ya me tengo que ir. Disculpenme.\n"
            "\n"
            "àøSe parái y se fuáQ!\n"
    ...
    /* MARCHING_ORDERS ("Marcher's Dáeary") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            "Abril 16:\n"
            "àøMe unáe al grupo de marchantes!\n"
            "àøVoy a darlo todo para ayudar a todo el mundo!\n"
            "\n"
            "Abril 20:\n"
            ...
            "a el sargento...\n"
            "àæDebe ser mi imaginaciáin, verdad?\n"
            "\n"
            "Mayo 22:\n"
            "àøNo me lo puedo creer! El sargento es...\n"
            "\n"
            "\n"
            "El registro termina aquáe.\n"
            "àæQuáQ le podráea estar pasando al sargento?",
        /* STYLE ---------------------------------------------------------- */
            /* GFX */ reading_style_cherry_gfx_table,
            /* BGM */ &reading_style_cherry_bgm
        /* ---------------------------------------------------------------- */
    ...
    /* RAP_MEN ("Rap Report") */ {
        /* TITLE ---------------------------------------------------------- */
            "Entrevista Rapera",
        /* BODY ----------------------------------------------------------- */
            "àøQue onda todos! àøSoy el DJ MON-KI!\n"
            "Hoy dáea tenemos unos increáebles invitados.\n"
            "àøUn fuerte aplauso para los Rapnificos! (RN)\n"
            "àøUn agrado estar con ustedes hoy!\n"
            "RN: àøHey oyentes desde sus casas! àøSomos los\n"
            "Rapnificos!\n"
            "DJ: Su à¶ltima canciáin es super buena, àæno?\n"
            "RN: àøClaro! Lo captas, àæhuh?\n"
            "DJ: àøDuh! Es àøasombrosa!\n"
            "RN: Aà¶nque si, estamos en un aprieto, àæsabes?\n"
            "DJ: àæOh? àæQue pasái?\n"
            "RN: Bueno, para empezar, acaban de aparecer otro\n"
            "dà¶o de raperas de la nada! Se hacen llamar las\n"
            "\"Rapnificas\", Creo.\n"
            "DJ: Puede ser, huh.\n"
            "RN: Seh. àøY esas impostoras se comieron todos\n"
            "los snacks que tenáeamos en nuesto estudio!\n"
            "DJ: àøNo lo puede creer!\n"
            "RN: Y si no fuera suficiente, dejaron una nota\n"
            "despues de comerse todo.\n"
            "DJ: àæY que decáea?\n"
            "RN: Decáea \"àøQue plan tan sencillo!\"\n"
            "DJ: Oh wow. Que incorregibles.\n"
            "RN: àæàøVerdad!? Fue lo suficiente para hacerme gritar...\n"
            "DJ: A que dijiste \"àøEspera, perdimos algo!\"\n"
            "RN: Uh... àøSeh! àæComo sabáeas eso?\n"
            #ifdef PARADISE
            "DJ: àøPorque he estado jugando Rhythm Paradise\n"
            "Advance ESP! àøPausa publicitácria!\n"
            "AN: àøMejora tu ritmo con Rhythm Paradise Advance\n"
            "ESP!\n"
            #else
            "DJ: àøPorque he estado jugando Rhythm Heaven\n"
            "Advance ESP! àøPausa publicitácria!\n"
            "AN: àøMejora tu ritmo con Rhythm Heaven Advance ESP!\n"
            #endif
            "àøDisponible ahora! El juego y la consola se venden\n"
            "por separado.\n"
            "Fin.",
        /* STYLE ---------------------------------------------------------- */
            /* GFX */ reading_style_cherry_gfx_table,
    ...
    /* REMIX3 ("Lyrics - Honey Sweet Angel of Love") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "àøAblanda el corazáin!\n"
            "\n"
            "àøMi dulce ácngel!\n"
            "\n"
            "Cáimo podráea explicar,\n"
            "Lo que es un \"Te amo\",\n"
            "àøYo la verdad, no sáQ!\n"
            "Podráea quizács decir,\n"
            "Como una brecha entre ambos,\n"
            "àøQue crece sin ningà¶n, control!\n"
            "\n"
            "Es algo agridulce\n"
            "Que no puedo soltar\n"
            "\n"
    ...
    /* REMIX8 ("The Final Letter") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "\n"
            "\"àøFelicidades en conseguir un perfecto en el remix 8!\n"
            "àøConseguir algo asáe si que es impresionante! ...es como\n"
            ...
            "àøEres lo mejor! àøUno de los mács increáebles! ...es como\n"
            ...
            "àøPor que desarrollar tu flow es la bomba!\n"
            "àøNo lo puedo recomendar mács! Y... bueno... Ejem.\n"
            "Deberáea dejar de emocionarme y empezar a\n"
            "recomendar.\n"
            "Te lo decimos en serio.\n"
            "àøEn serio queremos que entrenes tu flow lo mács que\n"
            "puedas!\n"
            "àøCreemos que tienes el potencial de liderar un mundo\n"
            "lleno de ritmo!\n"
            "àøEs mács, solo podemos creer en TI!\n"
            "àøTu en serio eres increáeble!\n"
            "àøMuchas gracias por jugar!\"\n"
    ...
    /* NINJA_BODYGUARD ("The Ninja Scroll") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "ninjutsu para que los buscara. àæLogran entenderlo?\n"
            ...
            "ArriesguáQ mi vida, àæquien sabe lo hubiera pasado?\n"
    ...
    /* TOSS_BOYS ("Rhythm Stand-Up") */ {
        /* TITLE ---------------------------------------------------------- */
            "Manzai Ritmico",
        /* BODY ----------------------------------------------------------- */
            "Yema: Hola, àøSoy Yema!\n"
            "Zefir: Hola, àøSoy Zefir!\n"
            "Ambos: àøEs un placer conocerte!\n"
            "Y: àøOye Zefir! àæOáeste?\n"
            "àøEstoy tomando una clase de mà¶sica!\n"
            "Z: Eh, àæen serio? àøGenial! àæQue instrumento tocas?\n"
            "àæEs la guitarra? àæO la bateráea?\n"
            "Y: Bueno, mi parte es...\n"
            "Z: àæCuácl? àæCuácl?\n"
            "Y: àøTocaráQ el ritmo!\n"
            "Z: àæQuáQ? No puedes \"tocar\" el ritmo, Yema.\n"
            "No es un instrumento. àæDonde lo oáeste?\n"
            "Y: Bueno, le dije al maestro que queráea tocar bateráea,\n"
            "àøy me respondiái que deberáea practicar con el\n"
            "\"ritmo\" para empezar!\n"
            "Z: Yema, creo que se refiriái a que necesitabas\n"
            "mejorar tu sentido del ritmo.\n"
            "Y: Claro, àøtiene todo el sentido del mundo! àøEso es\n"
            "increáeble! àæCáimo lo sabáeas? àæEres un psáequico?\n"
            "Z: Como y- àæàøPor quáQ no lo sabráea!?\n"
            "àøEs sentido comà¶n!\n"
            "Y: Oye viejo, no necesitas enfadarte tanto.\n"
            "Z: Ah, Tienes razáin, lo siento mucho...\n"
            "Y: àøUups! Zefir, àøtu cierre se bajái!\n"
            "Z: Ah, Espera, àæen serio?\n"
            "Y: Jáb, àøBROMA!\n"
            "Z: àøPor quáQ tendráea que!\n"
            "Y: \"Por quáQ tendráea que\" Viejo,\n"
            "eso es muy cursi.\n"
            "Z: àøCácllate, ya tuve suficiente!\n"
            "Y: àøAARGH!\n"
            "Z: àøàæEh?! àæPor quáQ te enojas? àæQue te hice?\n"
            "Y: àæNo hablabamos de mi clase de mà¶sica?\n"
            "Z: àæAh? Si, es cierto.\n"
            "Y: Tsss... Que manera de desviarse del asunto.\n"
            "Z: Ah, Lo siento... Espera, àøàæLO siento?!\n"
            "àøFuiste tu el que mintiái con que mi cierre estaba abajo!\n"
            "Y: àøOye oye! No necesitas molestarte tanto.\n"
            "Z: Oh, àøque amable! En fin, àæque hay de tu\n"
            "sentido del ritmo?\n"
            "Y: àøCierto! Mis colegas dijeron que mi\n"
            "\"Centáepedo del ritmo\" mejorarác practicando.\n"
            "Z: àøTu SENTIDO del ritmo, menso!\n"
            "Ambos: àøGracias! àøHan sido una maravillosa audiencia!\n",
        /* STYLE ---------------------------------------------------------- */
    ...
    /* FAN_MAIL ("Fan Mailbag") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            #endif
            "àøY son TANTAS que este email tendria 1000 pácginas\n"
            "si las mostrácramos todas!\n"
            "àøPero aquáe les dejamos unos cuantos\n"
            ...
            #endif
            "No me iba muy bien en el amor, àøpero ahora\n"
            ...
            "pero ahora, àøla gente me dice que mi canto es mejor!\n"
            "àøSigo siendo sorda al tono, claro, pero ahora soy feliz!\n"
            ...
            "pero ahora, he llegado tan lejos, àøque hasta la gente\n"
            ...
            "gracias a mi nuevo sentido de ritmo, àøhasta puedo\n"
            ...
            "a mi nuevo sentido de ritmo, àøahora soy un gran\n"
            "artista! àøY ahora mis amigos me adoran!\n"
    ...
    /* RHYTHM_DIAGNOSIS ("Rhythm Dáeagnosis") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "Si - àøVe a la pácgina 2!\n"
            "No - àøVe a la pácgina 3!\n"
            "-1-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Rock - àøVe a la pácgina 4!\n"
            "Pop - àøVe a la pácgina 5!\n"
            "\n"
            "-2-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Jazz - àøVe a la pácgina 6!\n"
            "Clasáeca - àøVe a la pácgina 7!\n"
            "\n"
            "-3-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Si - àøVe a la pácgina 8!\n"
            "No - àøVe a la pácgina 9!\n"
            "\n"
            "-4-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Si - àøVe a la pácgina 10!\n"
            "No - àøVe a la pácgina 11!\n"
            "\n"
            "-5-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Si - àøVe a la pácgina 9!\n"
            "No - àøVe a la pácgina 8!\n"
            "\n"
            "-6-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Si - àøVe a la pácgina 12!\n"
            "No - àøVe a la pácgina 13!\n"
            "\n"
            "-8-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Si - àøVe a la pácgina 14!\n"
            "No - àøVe a la pácgina 15!\n"
            "\n"
            "-9-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Si - àøVe a la pácgina 16!\n"
            "No - àøVe a la pácgina 17!\n"
            "\n"
            "-10-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Si - àøVe a la pácgina 18!\n"
            "No - àøVe a la pácgina 19!\n"
            "\n"
            "-11-\n"
            "\n"
            ...
            "\n"
            "\n"
            "Si - àøVe a la pácgina 23!\n"
            "No - àøVe a la pácgina 21!\n"
            "\n"
            "-12-\n"
            "\n"
            ...
            "Asegà¶rate de relajarte, àævale?\n"
            "\001C" "-21-\n"
            "\001C" "- Tu sentido de ritmo es -\n"
            ...
            "àøPráQstale atenciáin a tu sentido de ritmo, y\n"
            ...
            "àøSi encuentras maneras de integrar el sentido de ritmo\n"
    ...
    /* RHYTHM_POEM ("Rhythm Poem Digest") */ {
        ...
        /* BODY ----------------------------------------------------------- */
            ...
            "\001C" "\0030" "\001s" "\n"
            "àøHey Nene! àæque tal todo?\n"
            "Este ritmo no tie-ne fin.\n"
            "àøHey Nene! àøescucha atentamente!\n"
            "Yo puedo darte...\n"
            "Ese gran ritmo.\n"
            "Oh, si.\n"
            "àøAtento nene! àøconfáea en mi!\n"
            "Este ritmo, no tie-ne fin.\n"
            "àøUn nuevo brillo, en tu alma!\n"
            "àøOh si!\n"
            "Este ritmo.\n"
            "àøLo has entendidái muy bien!\n"
            "Hey nene...\n"

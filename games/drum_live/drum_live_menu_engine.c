...
const char *drum_live_menu_poster_desc[] = {
    ...
    "\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "ÅÙÅ@Paseo Nocturno\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "ÅÙÅ@Baile Astral\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "ÅÙÅ@Mi dulce ácngel\n"
    "\n",
    
    /* DRUM BOYS  */
    "\x03\x31" "\x01\x6d" "\x05\x30" "\x01\x34" "Drum Boys        En vivo!\n"
    "\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "ÅÙÅ@Trio Saleroso\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "ÅÙÅ@Prueba de ClaquáQ\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "ÅÙÅ@DESEO - Me duele seguir\n"
    ...
    "\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "\x01\x4c" "ÅÙÅ@Baile Cáismico\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "ÅÙÅ@Tráeo Garboso\n"
    "\x03\x30" "\x01\x73" "\x05\x31" "\x01\x35" "ÅÙÅ@Prueba de ClaquáQ 2\n"
    "\n"
};
